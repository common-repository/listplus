...
?>
<h2 class="l-form-title"><?php _e( 'Claim This Listing', 'list-plus' ); ?></h2>
<?php
...
?>
<form class="lp-form l-ajax-form l-claimn-form" action="" method="post" enctype="multipart/form-data">
	<?php
	wp_referer_field();
	$listing = ListPlus\get_listing();
	ListPlus()->form->hidden(
		[
			'action' => 'listplus_save_claim',
	...
	?>
	<input type="submit" class="button button-primary button-large" value="<?php esc_attr_e( 'Claim Listing', 'list-plus' ); ?>">
</form>
