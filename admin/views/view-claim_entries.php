...
$list_table = new ListPlus\Admin\Claim_Entries_List_Table();
$listing = null;
...
<div>
	<h1 class="wp-heading-inline">
		<?php if ( ! $listing ) { ?>
			<?php _e( 'Claim Entrires', 'list-plus' ); ?>
		<?php } else { ?>
			<?php printf( __( 'Claim Entrires for: <em>%s</em>', 'list-plus' ), esc_html( $listing->get_name() ) ); ?>
		<?php } ?>
	</h1>
</div>
